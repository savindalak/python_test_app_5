...
fig_1.update_layout(autosize=False, margin=dict(l=20,r=20,b=30,t=50,pad=4),plot_bgcolor='#66ffc2',xaxis = dict(
    tickvals =np.arange(no_of_months), tickmode = 'array', ticktext=get_sums_df('Laden').index),
                    title='Monthly LCH Working Hours and Boxes Handled ')
...
fig_2.update_layout(autosize=False, margin=dict(l=20,r=20,b=30,t=50,pad=4),plot_bgcolor='#80ff80',xaxis = dict(
    tickvals =np.arange(no_of_months), tickmode = 'array', ticktext=get_sums_df('ECH').index),
                    title='Monthly ECH Working Hours and Boxes Handled ')
...
fig_4.update_layout(autosize=False, margin=dict(l=20,r=20,b=30,t=50,pad=4),plot_bgcolor='#66ffc2',xaxis = dict(
    tickvals =np.arange(no_of_months), tickmode = 'array', ticktext=get_sums_df('Laden').index),
                    title='Monthly Laden Actual Gross Profit vs Forecast ')

fig_5 = profits(machine_type='ECH')
fig_5.update_layout(autosize=False, margin=dict(l=20,r=20,b=30,t=50,pad=4),plot_bgcolor='#80ff80',xaxis = dict(
    tickvals =np.arange(no_of_months), tickmode = 'array', ticktext=get_sums_df('ECH').index),
                    title='Monthly ECH Actual Gross Profit vs Forecast ')

fig_6 = profits(machine_type='Forklift')
fig_6.update_layout(autosize=False, margin=dict(l=20,r=20,b=30,t=50,pad=4),plot_bgcolor='#ffff66',xaxis = dict(
    tickvals =np.arange(no_of_months), tickmode = 'array', ticktext=get_sums_df('Forklift').index),
                    title='Monthly Forklift Actual Gross Profit vs Forecast ')

fig_7 = hours_vs_boxes_scatter(machine_type='Laden')
fig_7.update_layout(title='LCH Working Hours vs Boxes Handled', autosize=False, margin=dict(l=20,r=20,b=30,t=50,pad=4),plot_bgcolor='#66ffc2')

fig_8 = hours_vs_boxes_scatter(machine_type='ECH')
fig_8.update_layout(title='ECH Working Hours vs Boxes Handled', autosize=False, margin=dict(l=20,r=20,b=30,t=50,pad=4),plot_bgcolor='#80ff80')

fig_9 = hours_vs_boxes_scatter(machine_type='Forklift')
fig_9.update_layout(title='Forklift Working Hours vs Boxes Handled', autosize=False, margin=dict(l=20,r=20,b=30,t=50,pad=4),plot_bgcolor='#ffff66')

fig_10 = hours_vs_machines_scatter(machine_type='Laden')
fig_10.update_layout(title='LCH Availability vs Working Hours', autosize=False, margin=dict(l=20,r=20,b=30,t=50,pad=4),plot_bgcolor='#66ffc2')

fig_11 = hours_vs_machines_scatter(machine_type='ECH')
fig_11.update_layout(title='ECH Availability vs Working Hours', autosize=False, margin=dict(l=20,r=20,b=30,t=50,pad=4),plot_bgcolor='#80ff80')

fig_12 = hours_vs_machines_scatter(machine_type='Forklift')
fig_12.update_layout(title='Forklift Availability vs Working Hours', autosize=False, margin=dict(l=20,r=20,b=30,t=50,pad=4),plot_bgcolor='#ffff66')
'''================================================================================================================'''
...
layout = html.Div([
    html.Div([dcc.Link([html.Img(src='data:image/png;base64,{}'.format(
        ...
        html.H5("OPERATIONAL PERFORMANCE",style={'padding-top':'15px','font-weight': 'bold',
                                                     'color': '#ffffff',
                                                     'text-align': 'center'}),
    ]),
...
# adding a plot
    ...
    '10px','height':'200px', 'width':'400px','display': 'inline-block','top':'70px'})],id='link',href='/apps/operation_layouts/lch_hours_vs_boxes_layout'),
            dcc.Link([dcc.Graph(
        id='plot2', figure=fig_2, style={'position':'absolute','left':
    '515px','height':'200px', 'width':'300px','display': 'inline-block','top':'70px'})],href='/apps/operation_layouts/ech_hours_vs_boxes_layout'),
            dcc.Link([dcc.Graph(
        id='plot3', figure=fig_3, style={'position':'absolute','left':
    '1020px','height':'200px', 'width':'400px','display': 'inline-block','top':'70px'})],href='/apps/operation_layouts/fork_hours_vs_boxes_layout')],style={'padding-top':'50px'}),

    html.Div([dcc.Link([dcc.Graph(id='plot4', figure=fig_4, style={'position':'absolute','padding-left':
    '10px','height':'200px', 'width':'400px','display': 'inline-block','top':'340px'})],id='link',href='/apps/app5/4'),
          dcc.Link([dcc.Graph(
              id='plot5', figure=fig_5, style={'position': 'absolute', 'left':
                  '515px','height': '200px', 'width': '300px', 'display': 'inline-block','top':'340px'})], href='/apps/app5/5'),

        dcc.Link([dcc.Graph(
            id='plot6', figure=fig_6, style={'position': 'absolute','left':
    '1020px', 'height': '200px', 'width': '300px', 'display': 'inline-block','top':'340px'})], id='link', href='/apps/app5/6')],style={'padding-top':'50px'}),

    html.Div([dcc.Link([dcc.Graph(id='plot7', figure=fig_7, style={'position':'absolute','top':'610px','padding-left':
        '10px','height':'200px', 'width':'400px','display': 'inline-block'})],id='link',href='/apps/app5/4'),
              dcc.Link([dcc.Graph(
                  id='plot8', figure=fig_8, style={'position': 'absolute', 'left':
                      '515px', 'top':'610px','height': '200px', 'width': '300px', 'display': 'inline-block'})], href='/apps/app5/5'),

            dcc.Link([dcc.Graph(
                id='plot9', figure=fig_9, style={'position': 'absolute','top':'610px','left':
        '1020px', 'height': '200px', 'width': '300px', 'display': 'inline-block'})], id='link', href='/apps/app5/6')],style={'padding-top':'50px'}),
    ...
    html.Div(
        [dcc.Link([dcc.Graph(id='plot10', figure=fig_10, style={'position': 'absolute', 'top': '880px', 'padding-left':
         ...
         dcc.Link([dcc.Graph(
             ...
             href='/apps/app5/6')], style={'padding-top': '50px'})
