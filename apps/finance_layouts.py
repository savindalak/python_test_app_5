...
def profit_margin_by_machine_type():
    ...
    fig_layout = go.Layout(hovermode='closest', height=600)
    fig = go.Figure(layout=fig_layout)
...
fig_4 = profit_pie()
fig_4.update_layout(autosize=True, margin=dict(l=20,r=20,b=30,t=50,pad=4))

fig_5 = repair_cost_pie()
fig_5.update_layout(autosize=True, margin=dict(l=20,r=20,b=30,t=50,pad=4))

fig_6 = fuel_cost_pie()
fig_6.update_layout(autosize=True, margin=dict(l=20,r=20,b=30,t=50,pad=4))

fig_7 = profit_margin_by_machine_type()
fig_7.update_layout(autosize=True, margin=dict(l=20,r=20,b=30,t=50,pad=4),plot_bgcolor='#ff99e6',xaxis = dict(
    tickvals =np.arange(no_of_months), tickmode = 'array', ticktext=get_sums_df('Forklift').index),yaxis=dict(tickformat=".0%"),
                    )

fig_8 = repair_cost_comparison()
fig_8.update_layout(autosize=True, margin=dict(l=20,r=20,b=30,t=50,pad=4),plot_bgcolor='#ffb366',xaxis = dict(
    tickvals =np.arange(no_of_months), tickmode = 'array', ticktext=get_sums_df('Forklift').index),
                    title='Monthly Actual Repair Cost vs Budgeted Maintenance Cost')

fig_9 = profit_per_box_by_machine_type()
fig_9.update_layout(autosize=True, margin=dict(l=20,r=20,b=30,t=50,pad=4),plot_bgcolor='#d6d6c2',xaxis = dict(
    tickvals =np.arange(no_of_months), tickmode = 'array', ticktext=get_sums_df('Forklift').index),
                    )

fig_10 = profit_cum_line_graph()
fig_10.update_layout(autosize=True, margin=dict(l=20,r=20,b=30,t=50,pad=4),plot_bgcolor='#b3b3ff',xaxis = dict(
    tickvals =np.arange(no_of_months), tickmode = 'array', ticktext=get_sums_df('Forklift').index),
                    )

fig_11 = cost_comparison_line()
fig_11.update_layout(autosize=True, margin=dict(l=20,r=20,b=30,t=50,pad=4),plot_bgcolor='#b3ffff',xaxis = dict(
    tickvals =np.arange(no_of_months), tickmode = 'array', ticktext=get_sums_df('Forklift').index),
                    )

fig_12 = fuel_cost_cum_line_graph()
fig_12.update_layout(autosize=True, margin=dict(l=20,r=20,b=30,t=50,pad=4),plot_bgcolor='#ecb3ff',xaxis = dict(
    tickvals =np.arange(no_of_months), tickmode = 'array', ticktext=get_sums_df('Forklift').index),
                    )
'''================================================================================================================'''
...
actual_gp_vs_forecast_layout = html.Div([
    html.Div([dcc.Link([html.Img(src='data:image/png;base64,{}'.format(
        ...
        html.H5("MONTHLY ACTUAL GP VS FORECAST",style={'padding-top':'15px','font-weight': 'bold',
                                                     'color': '#ffffff',
                                                     'text-align': 'center'}),
    ]),
...
maintenance_cost_vs_gp_layout = html.Div([
    html.Div([dcc.Link([html.Img(src='data:image/png;base64,{}'.format(
        encoded_image),style={'position':'absolute','left':'10px','width':'45px','height':'45px'})],href='/apps/home'),
        html.H5("MONTHLY MAINTENANCE COST VS GP",style={'padding-top':'15px','font-weight': 'bold',
                                                     'color': '#ffffff',
                                                     'text-align': 'center'}),
    ]),
...
profit_margin_variation_layout = html.Div([
    html.Div([dcc.Link([html.Img(src='data:image/png;base64,{}'.format(
        encoded_image),style={'position':'absolute','left':'10px','width':'45px','height':'45px'})],href='/apps/home'),
        html.H5("MONTHLY PROFIT MARGIN VARIATION",style={'padding-top':'15px','font-weight': 'bold',
                                                     'color': '#ffffff',
                                                     'text-align': 'center'}),
    ]),
...
profit_pie_layout = html.Div([
    html.Div([dcc.Link([html.Img(src='data:image/png;base64,{}'.format(
        encoded_image),style={'position':'absolute','left':'10px','width':'45px','height':'45px'})],href='/apps/home'),
        html.H5("PROFIT DISTRIBUTION BY MACHINE TYPE",style={'padding-top':'15px','font-weight': 'bold',
                                                     'color': '#ffffff',
                                                     'text-align': 'center'}),
    ]),

    html.Div([dcc.Graph(id='plot4', figure=fig_4, style={'position': 'relative', 'padding-left':
            '10px', 'display': 'inline-block', 'width': '100%', 'height': '100%', 'padding-top': '20px'}),
                  dcc.Link([html.Button('Go Back',
                                        name='test', style={'font-weight': 'bold', 'position': 'absolute', 'width': '75px',
                                                            'left': '10px', 'bottom': '20px', 'height': '25px'})],
...
repair_cost_pie_layout = html.Div([
    html.Div([dcc.Link([html.Img(src='data:image/png;base64,{}'.format(
        encoded_image),style={'position':'absolute','left':'10px','width':'45px','height':'45px'})],href='/apps/home'),
        html.H5("REPAIR COST DISTRIBUTION BY MACHINE TYPE",style={'padding-top':'15px','font-weight': 'bold',
                                                     'color': '#ffffff',
                                                     'text-align': 'center'}),
    ]),

    html.Div([dcc.Graph(id='plot5', figure=fig_5, style={'position': 'relative', 'padding-left':
            '10px', 'display': 'inline-block', 'width': '100%', 'height': '100%', 'padding-top': '20px'}),
                  dcc.Link([html.Button('Go Back',
                                        name='test', style={'font-weight': 'bold', 'position': 'absolute', 'width': '75px',
                                                            'left': '10px', 'bottom': '20px', 'height': '25px'})],
...
fuel_cost_pie_layout = html.Div([
    html.Div([dcc.Link([html.Img(src='data:image/png;base64,{}'.format(
        encoded_image),style={'position':'absolute','left':'10px','width':'45px','height':'45px'})],href='/apps/home'),
        html.H5("FUEL COST DISTRIBUTION BY MACHINE TYPE",style={'padding-top':'15px','font-weight': 'bold',
                                                     'color': '#ffffff',
                                                     'text-align': 'center'}),
    ]),

    html.Div([dcc.Graph(id='plot6', figure=fig_6, style={'position': 'relative', 'padding-left':
            '10px', 'display': 'inline-block', 'width': '100%', 'height': '100%', 'padding-top': '20px'}),
                  dcc.Link([html.Button('Go Back',
                                        name='test', style={'font-weight': 'bold', 'position': 'absolute', 'width': '75px',
                                                            'left': '10px', 'bottom': '20px', 'height': '25px'})],
...
gp_margin_by_machine_layout = html.Div([
    html.Div([dcc.Link([html.Img(src='data:image/png;base64,{}'.format(
        encoded_image),style={'position':'absolute','left':'10px','width':'45px','height':'45px'})],href='/apps/home'),
        html.H5("MONTHLY GP MARGIN COMPARISON BY MACHINE TYPE",style={'padding-top':'15px','font-weight': 'bold',
                                                     'color': '#ffffff',
                                                     'text-align': 'center'}),
    ]),

    html.Div([dcc.Graph(id='plot7', figure=fig_7, style={'position': 'relative', 'padding-left':
            '10px', 'display': 'inline-block', 'width': '100%', 'height': '100%', 'padding-top': '20px'}),
                  dcc.Link([html.Button('Go Back',
                                        name='test', style={'font-weight': 'bold', 'position': 'absolute', 'width': '75px',
                                                            'left': '10px', 'bottom': '20px', 'height': '25px'})],
...
actual_vs_budgeted_repair_cost_layout = html.Div([
    html.Div([dcc.Link([html.Img(src='data:image/png;base64,{}'.format(
        encoded_image),style={'position':'absolute','left':'10px','width':'45px','height':'45px'})],href='/apps/home'),
        html.H5("MONTHLY ACTUAL REPAIR COST vs BUDGETED MAINTENANCE COST",style={'padding-top':'15px','font-weight': 'bold',
                                                     'color': '#ffffff',
                                                     'text-align': 'center'}),
    ]),

    html.Div([dcc.Graph(id='plot8', figure=fig_8, style={'position': 'relative', 'padding-left':
            '10px', 'display': 'inline-block', 'width': '100%', 'height': '100%', 'padding-top': '20px'}),
                  dcc.Link([html.Button('Go Back',
                                        name='test', style={'font-weight': 'bold', 'position': 'absolute', 'width': '75px',
                                                            'left': '10px', 'bottom': '20px', 'height': '25px'})],
...
profit_per_box_layout = html.Div([
    html.Div([dcc.Link([html.Img(src='data:image/png;base64,{}'.format(
        encoded_image),style={'position':'absolute','left':'10px','width':'45px','height':'45px'})],href='/apps/home'),
        html.H5("PROFIT PER BOX HANDLED BY MACHINE TYPE",style={'padding-top':'15px','font-weight': 'bold',
                                                     'color': '#ffffff',
                                                     'text-align': 'center'}),
    ]),

    html.Div([dcc.Graph(id='plot9', figure=fig_9, style={'position': 'relative', 'padding-left':
            '10px', 'display': 'inline-block', 'width': '100%', 'height': '100%', 'padding-top': '20px'}),
                  dcc.Link([html.Button('Go Back',
                                        name='test', style={'font-weight': 'bold', 'position': 'absolute', 'width': '75px',
                                                            'left': '10px', 'bottom': '20px', 'height': '25px'})],
...
profit_vs_forecast_layout = html.Div([
    html.Div([dcc.Link([html.Img(src='data:image/png;base64,{}'.format(
        encoded_image),style={'position':'absolute','left':'10px','width':'45px','height':'45px'})],href='/apps/home'),
        html.H5("CUMULATIVE PROFIT VS FORECAST",style={'padding-top':'15px','font-weight': 'bold',
                                                     'color': '#ffffff',
                                                     'text-align': 'center'}),
    ]),

    html.Div([dcc.Graph(id='plot10', figure=fig_10, style={'position': 'relative', 'padding-left':
            '10px', 'display': 'inline-block', 'width': '100%', 'height': '100%', 'padding-top': '20px'}),
                  dcc.Link([html.Button('Go Back',
                                        name='test', style={'font-weight': 'bold', 'position': 'absolute', 'width': '75px',
                                                            'left': '10px', 'bottom': '20px', 'height': '25px'})],
...
budgeted_vs_actual_maintenance_cost_layout = html.Div([
    html.Div([dcc.Link([html.Img(src='data:image/png;base64,{}'.format(
        encoded_image),style={'position':'absolute','left':'10px','width':'45px','height':'45px'})],href='/apps/home'),
        html.H5("CUMULATIVE BUDGETED MAINTENANCE COST VS ACTUAL",style={'padding-top':'15px','font-weight': 'bold',
                                                     'color': '#ffffff',
                                                     'text-align': 'center'}),
    ]),

    html.Div([dcc.Graph(id='plot11', figure=fig_11, style={'position': 'relative', 'padding-left':
            '10px', 'display': 'inline-block', 'width': '100%', 'height': '100%', 'padding-top': '20px'}),
                  dcc.Link([html.Button('Go Back',
                                        name='test', style={'font-weight': 'bold', 'position': 'absolute', 'width': '75px',
                                                            'left': '10px', 'bottom': '20px', 'height': '25px'})],
...
budgeted_vs_actual_fuel_cost_layout = html.Div([
    html.Div([dcc.Link([html.Img(src='data:image/png;base64,{}'.format(
        encoded_image),style={'position':'absolute','left':'10px','width':'45px','height':'45px'})],href='/apps/home'),
        html.H5("CUMULATIVE BUDGETED FUEL COST VS ACTUAL",style={'padding-top':'15px','font-weight': 'bold',
                                                     'color': '#ffffff',
                                                     'text-align': 'center'}),
    ]),

    html.Div([dcc.Graph(id='plot11', figure=fig_12, style={'position': 'relative', 'padding-left':
            '10px', 'display': 'inline-block', 'width': '100%', 'height': '100%', 'padding-top': '20px'}),
                  dcc.Link([html.Button('Go Back',
                                        name='test', style={'font-weight': 'bold', 'position': 'absolute', 'width': '75px',
                                                            'left': '10px', 'bottom': '20px', 'height': '25px'})],
